...
!function($) {
    ...
    var htmlLayerTpl = ['<div class="modal modal1">', '<div class="modal_dialog">', '<div class="modal_content pie_about">', '<div class="modal_header">', '<span class="title J_modal_title"></span>', '<span class="max_remind J_modal_max"></span>', '<a href="javascript:;" class="close J_dismiss_modal"></a>', '</div>', '<div class="modal_body">', '<div class="listed_group" id="J_listed_group">', '<div class="left_text">已选择：</div>', '<div class="center_text" id="J_listed_content"></div>', '<a href="javascript:;" class="right_text" id="J_listed_clear">清空</a>', '<div class="clear"></div>', '</div>', '<div class="J_modal_content"></div>', '</div>', '<div class="modal_footer">', '<div class="res_add_but">', '<div class="butlist">', '<div class="btn_blue J_hoverbut btn_100_38 J_btnyes">确 定</div>', '</div>', '<div class="butlist">', '<div class="btn_lightgray J_hoverbut btn_100_38 J_dismiss_modal J_btncancel">取 消</div>', '</div>', '<div class="clear"></div>', '</div>', '</div>', '<input type="hidden" class="J_btnload" />', '</div>', '</div>', '</div>'].join('');
    // 点击显示行业分类
    ...
    $('#J_showmodal_city1').live('click', function() {
        ...
        if (classifyModel) {
            ...
            // 恢复选中
            var recoverValue = $('#J_showmodal_city1 .J_resultcode_city1').val();
            ...
            $('.J_list_city').die().live('click', function() {
                if ($(this).hasClass('seledted')) { // 已经是选中状态
                    ...
                    if (multipleValue) {
                        ...
                        var code = $(this).data('code');
                        var title = $(this).data('title');
                        $('#J_showmodal_city1 .J_resultcode_city1').val(code);
                        $('#J_showmodal_city1 .J_resuletitle_city1').text(title);
                        $('#J_showmodal_city1 .J_resuletitle_city1').attr('title', title);
                        $('.modal_backdrop').remove();
                        $('.modal').remove();
                    }
                }
            ...
            $('#J_btnyes_city').die().live('click', function() {
                ...
                $('#J_showmodal_city1 .J_resultcode_city1').val(codeArray.join(','));
                $('#J_showmodal_city1 .J_resuletitle_city1').text(titleArray.length ? titleArray.join('+') : '请选择');
                $('#J_showmodal_city1 .J_resuletitle_city1').attr('title', titleArray.length ? titleArray.join('+') : '请选择');
                removeModal();
            });
        } else {
            // 三级分类
            ...
            $('.J_list_city').die().live('click', function() {
                if (multipleValue) {// 多选
                    ...
                    $('#J_showmodal_city1 .J_resultcode_city1').val(code);
                    $('#J_showmodal_city1 .J_resuletitle_city1').text(title + '/' + title1 + '/' + title2);
                    $('#J_showmodal_city1 .J_resuletitle_city1').attr('title', title);
                    $('.modal_backdrop').remove();
                    $('.modal').remove();
                }
